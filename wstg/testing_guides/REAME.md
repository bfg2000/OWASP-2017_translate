...
![Image alt](https://github.com/bfg2000/OWASP-2017_translate/blob/main/wstg/testing_guides/images/1.png)
...
<ins>Тестируйте раньше и тестируйте часто</ins>
...
<ins>Автоматизация тестирования</ins>
...
<ins>Понять объем безопасности</ins>
...
<ins>Развивайте правильный образ мышления</ins>
...
<ins>Разработка показателей</ins>
...
<ins>Задокументируйте результаты теста</ins>
...
<ins>Объяснение методов тестирования</ins>
В этом разделе представлен общий обзор различных методов тестирования, которые можно использовать при построении программы тестирования. В нем не представлены конкретные методологии для этих методов, так как эта информация содержится в главе 3. Этот раздел включен для обеспечения контекста структуры, представленной в следующей главе, и для выделения преимуществ или недостатков некоторых методов, которые следует учитывать. 
...
- на первичном этапе SDLC

Недостатки
- может занять много времени
- вспомогательный материал не всегда доступен
- для эффективности требуется значительная квалификация и навыки
- моделирование угроз
...
<ins>Для разработки модели угроз</ins> мы рекомендуем использовать простой подход, соответствующий стандарту NIST 800-30 для оценки рисков. 
...
Преимущества:
- взгляд с точки зрения злоумышленника на систему
- гибкость
- на первоначальном этапе SDLC

Недостатки:
- хорошие модели угроз не означают автоматически хорошее программное обеспечение

<ins>ПРОСМОТР ИСХОДНОГО КОДА</ins> - это процесс ручной проверки исходного кода веб-приложения на наличие проблем безопасности. Многие серьезные уязвимости в системе безопасности не могут быть обнаружены никакими другими методами анализа или тестирования. 
Как гласит популярная поговорка: «Если вы хотите знать, что на самом деле происходит, идите прямо к источнику». Практически все эксперты по безопасности согласны с тем, что ничто не может заменить фактический просмотр кода. Вся информация для выявления проблем безопасности содержится где-то в коде. В отличие от тестирования закрытого программного обеспечения, такого как операционные системы, при тестировании веб-приложений (особенно если они были разработаны собственными силами) исходный код должен быть доступен для целей тестирования.
...
<ins>Тестирование на проникновение</ins>
...
Недостатки
- выполняется на поздних этапах SDLC
...
![Image alt](https://github.com/bfg2000/OWASP-2017_translate/blob/main/wstg/testing_guides/images/2.png)

На следующем рисунке показано типичное пропорциональное представление, наложенное на методы тестирования.

![Image alt](https://github.com/bfg2000/OWASP-2017_translate/blob/main/wstg/testing_guides/images/3.png)


<ins>Замечание о сканерах веб-приложений</ins>
...
<b>Пример 1: Магические параметры</b>
...
чтобы еще больше упростить пример, значения в этом случае могут быть только символами ASCII a - z (верхний или нижний регистр) и целыми числами 0 - 9.
...
<b>Пример 2: Плохая криптография</b>
...
<ins>Примечание об инструментах просмотра статического исходного кода</ins>
...
<b>Требования к тестированию безопасности</b>
...
<ins>Документация по требованиям безопасности</ins>
...
Общий контрольный список применимых норм, стандартов и политик является хорошим предварительным анализом соответствия требованиям безопасности для веб-приложений. Например, соответствие нормативным требованиям можно определить, проверив информацию о бизнес-секторе, стране или штате, где будет работать приложение. Некоторые из этих руководящих принципов и правил соответствия могут быть преобразованы в конкретные технические требования к мерам безопасности. Например, в случае финансовых приложений, соответствие Инструменту и документации по оценке кибербезопасности Федерального совета финансовых учреждений (FFIEC) требует, чтобы финансовые учреждения внедряли приложения, которые снижают риски слабой аутентификации с помощью многоуровневого контроля безопасности и многофакторной аутентификации.
...
<ins>Проверка требований безопасности</ins>
...
<ins>Классификация угроз и мер противодействия</ins>
...
- Разрешить функцию смены пароля только для аутентифицированных пользователей, подтвердив старый пароль, новый пароль и ответ пользователя на контрольный вопрос, чтобы предотвратить грубый перебор пароля через смену пароля.
...
<ins>Требования безопасности с учетом рисков</ins>
...
- Взаимная аутентификация клиента и сервера для предотвращения атак DDoS и MiTM.
...
<ins>Получение требований к тестированию безопасности на основе случаев использования и злоупотреблений</ins>
...
![Image alt](https://github.com/bfg2000/OWASP-2017_translate/blob/main/wstg/testing_guides/images/4.png)
...
<b>Тесты безопасности, интегрированные в рабочие процессы разработки и тестирования</b>

<ins>Тестирование безопасности в процессе разработки</ins>
...
<ins>Тестирование безопасности в рабочем процессе тестирования</ins>
...
<ins>Тесты безопасности разработчика</ins>
...
<ins>Тесты безопасности функциональных тестеров</ins>
...
<ins>Анализ данных тестирования безопасности и создание отчетов</ins>
...
- исправление или противодействие каждой уязвимости; 
